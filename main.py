...
from my_loss_function import loss_label_smoothing, loss_kd_regularization, loss_kd, loss_kd_self, ptloss
...
parser.add_argument('--log_path', default='tfkd.log/', help="log name")
...
parser.add_argument('--perturb', action='store_true', default=False, help="flag for ptloss")
...
def main():
    ...
    # Set the logger
    utils.set_logger(os.path.join(args.model_dir, args.log_path))
